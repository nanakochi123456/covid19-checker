...
//alert(name + "=" + form);
	...
	function load_covid19form() {
		...
		inslist(HTML,"sake", "飲酒はされますか？"
			, "0-0-1-0=しない"
			, "0-0-1.2-1=ハイボール、チューハイを少し"
			, "0-0-1.75-1=ハイボール、チューハイをたくさん"
			, "0-0-1.5-1=ビール、ワインを少し"
			, "0-0-2-1=ビール、ワインをたくさん"
			, "0-0-1.7-1=日本酒を少し"
			, "0-0-2.4-1=日本酒をたくさん"
		...
		insmatrix(HTML,"syoujou", "現在の症状"
			...
			, "0-0-1-6=鼻水"
			, "0-0-1-7=のどの痛み"
			, "0-0-1-8=味が感じられない"	// オミクロンではまずない
			, "0-0-1-9=臭い、香りが感じられない"	// オミクロンではまずない
			, "1-1-1-10=唇が紫になっている"
			, "1-1-1-11=ワクチンの接種を放置してる"
			, "1-1-1-12=水などの飲み物が飲めない"
			, "1-1-1-13=食事等が食べられない"
			, "1-1-1-14=息が荒くなった"
			, "1-1-1-15=急に息苦しくなった"
			, "1-1-1-16=肩で息をしている"
			...
			, "1-1-1-18=胸に痛みがある"
			, "1-1-1-19=横になれない"
			, "1-1-1-20=座らないと息ができない"
			, "1-1-1-21=肩で息をしている"
			, "1-1-1-22=突然ゼーゼーしてきた"
			, "1-1-1-23=脈が飛ぶ、脈のリズムが乱れてる"
			, "1-1-1-24=いつもよりぼんやりしている"
			, "1-1-1-25=様子がおかしい"
			, "1-1-1-26=もうろうとしている"
		);
