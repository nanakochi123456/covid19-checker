...
/* 以下は変更禁止 */
covid19_footer='<p>本ウェブサイトのうち新型コロナウイルス受診ナビは個人、法人、団体関わらず無断転載歓迎です。詳細は<a href="https://github.com/nanakochi123456/covid19-checker">github</a>まで</p><p>この簡易診断サイトは統計データに基づき作成されたもので、医師並びに医療従事者が監修を行っていません。ただしすべての内容につきまして現役の2021年度新任医師（一般病院所属）に、一部の内容につきましては現役フリーランスの内科医（一般病院所属）の方に確認を受けています。</p><p>統計データの入手元につきましては<a href="https://github.com/nanakochi123456/covid19-checker/blob/main/covid19.sjs">ソースコード</a>に記載されています。</p><p>この結果につきましては診断を行った行為とはならず、あくまで利用者の参考情報として提供しています。</p><p>すべての統計データが網羅されていないため、重症化率に限り正しく計算されないことがあります。</p><p>当フォームに入力された内容はサーバー並びにcookie等に保管されません。</p><p>本簡易診断は日本国内の実態に基づいて作成しています。</p><p>&nbsp;</p><p>&copy;<a href="https://neet.co.jp/">NEET Co.,Ltd.</a> All Right Reserved.</p><p>This is open source. <a href="https://github.com/nanakochi123456/covid19-checker">github source</a> <a href="https://www.gnu.org/licenses/gpl-3.0.ja.html">GPL3</a> <a href="https://blog.neet.co.jp/contact/">Contact</a></p>',
	/* /以上変更禁止 */
...
covid19_negative = 
	FORCEJUSIN == 0 ?
		'あなたは受診の必要はないと思われますが、インフルエンザの可能性もありますのでオンラインで受診をしましょう。<br>検査や薬の為に受診することは避けましょう。<br>総合的に他の症状との考慮を行い、全くなければ検査や薬の為に受診することは避けましょう。<br><br>オミクロン株では順調に経過すれば風邪とは大きな違いはなく、自分の免疫だけで治すことができます。このページを毎日チェックして簡易問診をしてみましょう。<br>しかし、最近では若年層の方が軽症でも死亡されるケースがございます。ちょっとした異変でも感じられましたらすぐに<a href="tel:119">119</a>をするようにしましょう。<br><br>感染拡大に伴い宿泊療養のホテルは満床近いケースがあります。可能な限りご自宅で家庭内感染をしないよう工夫をしながら療養するようにしましょう。<br><br>'
			:
		'あなたは受診をするほうが望ましいです。<br>現在医療機関に余裕が少しはあるため、安心の為に受診することをお薦めします。<br>最近では若年層の方が軽症でも死亡されるケースがございます。ちょっとした異変でも感じられましたらすぐに<a href="tel:119">119</a>をするようにしましょう。<br><br>感染拡大に伴い宿泊療養のホテルは満床近いケースがあります。可能な限りご自宅で家庭内感染をしないよう工夫をしながら療養するようにしましょう。<br><br>'
		,
